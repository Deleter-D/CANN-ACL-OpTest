...
int main() {
  ...
  auto input_x = new npuTensor<float>(ACL_FLOAT,
                                      ...
                                      x_data.data(),
                                      memType::HOST);
  auto input_roi = new npuTensor<float>(ACL_FLOAT,
                                        roi_dims.size(),
                                        roi_dims.data(),
                                        ACL_FORMAT_ND,
                                        roi_data.data(),
                                        memType::HOST);
  auto input_scales = new npuTensor<float>(ACL_FLOAT,
                                           scales_dims.size(),
                                           scales_dims.data(),
                                           ACL_FORMAT_ND,
                                           scales_data.data(),
  ...
  // output - out
  auto output_y = new npuTensor<float>(ACL_FLOAT,
                                       y_dims.size(),
                                       y_dims.data(),
                                       ACL_FORMAT_NCHW,
                                       nullptr,
